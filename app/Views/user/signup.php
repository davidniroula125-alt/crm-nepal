...
.divider{display:flex;align-items:center;gap:12px;margin:20px 0;font-size:.82rem;color:var(--muted)}
...
<div class="login-left">
  <div class="login-left-content">
    ...
    <div class="login-features">
      ...
      <div class="login-feature">
        <span class="login-feature-icon">&#128101;</span>
        Manage unlimited leads and clients
      </div>
      <div class="login-feature">
        <span class="login-feature-icon">&#128274;</span>
  ...
  <div class="login-card">
    ...
    <form method="POST" action="<?= site_url('user/signup') ?>">
      ...
      <div class="field">
        ...
        <input type="text" name="name" value="<?= esc(old('name')) ?>" placeholder="Your full name" required autofocus>
      </div>
      <div class="field">
        <label>Email Address</label>
        <input type="email" name="email" value="<?= esc(old('email')) ?>" placeholder="your@email.com" required>
      </div>
      <div class="field">
    ...
    <div class="links">Already have an account? <a href="<?= site_url('user/login') ?>">Sign In</a></div>
