...
<div class="admin-form-wrapper">
    <form method="POST" action="<?= site_url("/admin/testimonials/{$testimonial->id}/update") ?>">
        <?= csrf_field() ?>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   name="company"
                   class="form-control"
                   value="<?= esc(old('company', $testimonial->company)) ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   name="designation"
                   class="form-control"
                   value="<?= esc(old('designation', $testimonial->designation)) ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   name="profile_image"
                   class="form-control"
                   value="<?= esc(old('profile_image', $testimonial->profile_image)) ?>"
        ...
        <div class="form-group">
            ...
            <textarea id="testimonial_text"
                      ...
                      class="form-control"
                      rows="5"
                      required><?= esc(old('testimonial_text', $testimonial->testimonial_text)) ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <select id="star_rating" name="star_rating" class="form-control" required>
                ...
                <?php for ($i = 1; $i <= 5; $i++): ?>
                    <option value="<?= $i ?>" <?= old('star_rating', $testimonial->star_rating) == $i ? 'selected' : '' ?>>
                        <?= $i ?> <?= $i === 1 ? 'Star' : 'Stars' ?>
                    </option>
                <?php endfor; ?>
            </select>
        ...
        <div class="form-group">
            ...
            <input type="number"
                   ...
                   name="sort_order"
                   class="form-control"
                   value="<?= esc(old('sort_order', $testimonial->sort_order)) ?>">
        </div>
        ...
        <div class="form-actions">
            ...
            <a href="<?= site_url("/admin/testimonials/{$testimonial->id}") ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
