...
<div class="admin-form-wrapper">
    <form method="POST" action="<?= site_url("/admin/clients/{$client->id}/update") ?>">
        <?= csrf_field() ?>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   name="company_name"
                   class="form-control"
                   value="<?= esc(old('company_name', $client->company_name)) ?>"
                   required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   ...
                   name="contact_name"
                   class="form-control"
                   value="<?= esc(old('contact_name', $client->contact_name)) ?>"
                   required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="address"
                      name="address"
                      class="form-control"
                      rows="3"><?= esc(old('address', $client->address)) ?></textarea>
        </div>
                ...
                <?php if (! empty($leads)): ?>
                    <?php foreach ($leads as $lead): ?>
                        <option value="<?= esc($lead->id) ?>"
                            <?= old('lead_id', $client->lead_id) == $lead->id ? 'selected' : '' ?>>
        ...
        <div class="form-actions">
            ...
            <a href="<?= site_url("/admin/clients/{$client->id}") ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
