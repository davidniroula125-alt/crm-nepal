...
<div class="admin-form-wrapper">
    <form method="POST" action="<?= site_url('/admin/subscriptions/store') ?>">
        <?= csrf_field() ?>
                ...
                <select id="plan_name" name="plan_name" class="form-control" required>
                    ...
                    <?php foreach ($pricingPlans as $plan): ?>
                        <option value="<?= esc($plan->name) ?>"
                            <?= old('plan_name') === $plan->name ? 'selected' : '' ?>>
        ...
        <div class="form-actions">
            ...
            <a href="<?= site_url('/admin/subscriptions') ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
